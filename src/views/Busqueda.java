...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		btnbuscar.setBounds(748, 129, 137, 31);
		...
		Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
				.ifPresent(fila -> {
					...
					if (tbReservas.getSelectedColumn() == 0) {
						JOptionPane.showMessageDialog(this, "No se pueden editar los ID existentes");
					} else {
	...
	public String calcularValorReserva(LocalDate dataE, LocalDate dataS) {
		if (dataE != null && dataS != null) {
			int dias = (int) ChronoUnit.DAYS.between(dataE, dataE);
			int noche = 40;
